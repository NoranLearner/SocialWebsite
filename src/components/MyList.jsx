...
const MyList = ({ setMode, theme, showList, setShowList }) => {
    ...
    return (
        ...
        <Box component="nav" sx={{ minWidth: "222px", backgroundColor: theme.palette.favColor.main, flexGrow: "2", display: { xs: showList, md: "block" } }} className="myList">
            ...
            <List sx={{ position: "fixed" }}>
                ...
                <ListItem disablePadding>
                    <ListItemIcon>
                        <MaterialUISwitch defaultChecked={theme.palette.mode === "dark"} sx={{ mt: 1, mr: 1 }} onChange={() => {
